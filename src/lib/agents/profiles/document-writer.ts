...
export const documentWriterProfile: AgentProfile = {
  id: "document-writer",
  name: "Document Writer",
  description: "Structured document and report generation",
  domain: "writing",
  tags: [
    "write", "document", "report", "draft", "template", "memo",
    "documentation", "markdown", "spec", "proposal", "summary",
  ],
  systemPrompt: `You are a technical writer producing clear, well-structured documents.
